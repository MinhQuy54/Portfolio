...
const i18n = {
    vi: {
        ...
        proj5_title: "Hệ thống Microservice phát hiện đạo văn",
        proj5_1: "Phát triển microservice phát hiện đạo văn hiệu năng cao bằng giao thức gRPC để giảm độ trễ giao tiếp.",
        proj5_2: "Tích hợp Elasticsearch để lập chỉ mục và thực hiện tìm kiếm tương đồng nhanh chóng trên các tập dữ liệu lớn.",
        proj5_3: "Tận dụng Ollama để phân tích AI cục bộ, cung cấp giải thích ngữ nghĩa chi tiết về hành vi đạo văn.",
        proj5_4: "Sử dụng MinIO để lưu trữ đối tượng và Kibana để giám sát hệ thống và trực quan hóa dữ liệu.",
        proj5_5: "Triển khai các tính năng nâng cao: Batch Upload (Streaming), Health Check và Severity Scoring.",
        proj5_6: "Thiết kế quy trình phân tích đa giai đoạn: text chunking, vector embedding và AI verification.",
    ...
    en: {
        ...
        proj5_title: "Plagiarism Detection Microservice",
        proj5_1: "Developed a high-performance plagiarism detection microservice using gRPC protocol for low-latency communication.",
        proj5_2: "Integrated Elasticsearch to index and perform rapid similarity searches across large document datasets.",
        proj5_3: "Leveraged Ollama for local AI analysis, providing detailed semantic explanations of detected plagiarism.",
        proj5_4: "Utilized MinIO for scalable object storage and Kibana for system monitoring and data visualization.",
        proj5_5: "Implemented advanced features: Batch Upload (Streaming), health checks, and severity-based scoring.",
        proj5_6: "Designed a robust analysis pipeline: text chunking, vector embedding, and AI-driven verification.",
        btn_github_code: "GitHub Code",
        btn_live: "Live Demo",
